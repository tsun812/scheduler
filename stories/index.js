...
storiesOf("Appointment", module)
  ...
  .add("Form edit status", () => <Form student="Lydia Miller-Jones" interviewer={interviewer.id} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
  .add("Form create status", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
